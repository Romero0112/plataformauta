        ...
        <div class="form-group" style="text-align: center;">
            ...
            <?php if ($error_message !== ''): ?>
                <div class="button-microsoft"
                    style="position: relative; top: 20px; left: 50%; transform: translateX(-50%); z-index: 1;">
                    <?php echo $error_message; ?>
                </div>
            <?php endif; ?>

            <form method="post" action="interfaz.php">
            ...
            ?>
            <!-- <button type="button" class="button-cookies" onclick="mostrarAvisoCookies()">Aviso de Cookies</button> -->
        </div>
    </div>

    <!-- <script>
        function mostrarAvisoCookies() {
            alert("Utilizamos cookies para mejorar su experiencia en el sitio. Al continuar navegando, acepta nuestro uso de cookies.");
        }
    </script> -->
